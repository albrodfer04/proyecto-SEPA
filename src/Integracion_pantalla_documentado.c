    ...
    while (1)
    {
        ...
        if (contador >= 100)
        {
            ...
            case 1:
                ...
                ang = 45;
                led(0, 255, 0);
                MandaMensaje("LED verde");
                break;
            case 2:
                motor_Encendido_Apagado(0);
                ang = 90;
                led(0, 0, 255);
                MandaMensaje("LED azul");
                break;
            case 3:
                motor_Direccion(0);
                motor_Velocidad(30);
...
void DatosPantalla(void)
{
    ...
    {
        SysCtlDelay(10 * MSEC);
        while (Boton(HSIZE * 4 / 5, VSIZE / 2 + 30, HSIZE / 6 + 5, HSIZE / 6 + 5, 28, "AIRE"))
            ; // Debouncing
        SysCtlDelay(10 * MSEC);
    ...
    {
        SysCtlDelay(10 * MSEC);
        while (Boton(HSIZE * 7 / 12, VSIZE / 2 + 30, HSIZE / 6 + 5, HSIZE / 6 + 5, 28, "LUZ"))
            ; // Debouncing
        SysCtlDelay(10 * MSEC);
        lampara = !lampara;
    }
